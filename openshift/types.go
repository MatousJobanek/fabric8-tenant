...
func (t *CommonEnvTypeService) GetNamespace() string {
...
func (t *UserNamespaceTypeService) AfterCallback(client *Client, action string) error {
	...
	deleteErr := errorWrapper{}
	apply(&removeRoleWait, *client, http.MethodDelete, adminRoleBinding, &deleteErr)

	return deleteErr.createMultiError("unable to remove adminrolebinding in %s namespace.", t.GetNamespace())
}
