...
func TestWhoAmI(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		// when
		username, err := cluster.WhoAmI(context.Background(), "https://openshift.test", tok.Raw, commonConfig.WithRoundTripper(r))
		// then
		require.NoError(t, err)
	...
	t.Run("forbidden", func(t *testing.T) {
		// when
		username, err := cluster.WhoAmI(context.Background(), "https://openshift.test", "", commonConfig.WithRoundTripper(r))
		// then
		require.Error(t, err)
