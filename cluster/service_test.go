...
func TestResolveCluster(t *testing.T) {
	...
	// given
	authService := testdoubles.NewAuthClientService(t, "../test/data/cluster/resolve_cluster.fast", "http://fast.authservice", recorder.WithJWTMatcher)
...
func TestGetClusters(t *testing.T) {
	// given
	authService := testdoubles.NewAuthClientService(t, "../test/data/cluster/resolve_cluster.slow", "http://slow.authservice", recorder.WithJWTMatcher)
	authService.Config.Set(configuration.VarAuthTokenKey, "foo")
	saToken, err := testsupport.NewToken(
		map[string]interface{}{
			"sub": "tenant_service",
